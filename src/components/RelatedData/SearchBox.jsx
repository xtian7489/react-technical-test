    ...
    <div className="flex flex-col md:flex-row w-full md:w-auto gap-3">
      <div className="relative w-full">
        ...
        <input
          ...
          className="pl-10 pr-4 py-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-${focusRingColor}-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
          value={searchTerm}
